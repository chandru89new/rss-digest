...
/* package rss-digest-0.1.0.0 */
#ifndef VERSION_rss_digest
#define VERSION_rss_digest "0.1.0.0"
#endif /* VERSION_rss_digest */
#ifndef MIN_VERSION_rss_digest
#define MIN_VERSION_rss_digest(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_rss_digest */
/* package async-2.2.5 */
...
/* package http-conduit-2.3.9 */
#ifndef VERSION_http_conduit
#define VERSION_http_conduit "2.3.9"
...
#define CURRENT_COMPONENT_ID "rss-digest-0.1.0.0-inplace-rss-digest"
